...
### 1.1.1 绝对的限制cpu使用资源 cpu.cfs_quota_us/cpu.cfs_period_us
...
## 1.2 一些概念
>子系统(subsystem)/层级(hierarchy)/控制组(controller group)/任务(tasks) 
...
## 2.1 假设存在一个2c2g的pod,看系统是如何实现资源控制的
